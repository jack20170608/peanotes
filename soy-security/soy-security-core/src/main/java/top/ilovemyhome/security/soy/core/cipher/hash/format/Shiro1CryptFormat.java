...
import top.ilovemyhome.security.soy.core.cipher.hash.SimpleHash;
import top.ilovemyhome.security.soy.core.cipher.hash.SimpleHashProvider;
...
public class Shiro1CryptFormat implements ModularCryptFormat, ParsableHashFormat {
    ...
    public Hash parse(final String formatted) {
        ...
        if (StrUtils.hasLength(saltBase64)) {
