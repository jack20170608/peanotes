...
import top.ilovemyhome.security.soy.core.exception.authz.UnauthenticatedException;
import top.ilovemyhome.security.soy.core.exception.session.DisabledSessionException;
...
import top.ilovemyhome.security.soy.core.mgt.session.DefaultSessionContext;
import top.ilovemyhome.security.soy.core.mgt.session.SessionContext;
...
import top.ilovemyhome.security.soy.core.subject.support.SubjectCallable;
import top.ilovemyhome.security.soy.core.subject.support.SubjectRunnable;
...
public class DelegatingSubject implements Subject {
    ...
    public PrincipalCollection getPrincipals() {
        ...
        return CollectionUtil.isEmpty(runAsPrincipals) ? this.principals : runAsPrincipals.get(0);
    }
    ...
    public boolean isRunAs() {
        ...
        return !CollectionUtil.isEmpty(stack);
    }
