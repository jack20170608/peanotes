...
import top.ilovemyhome.security.soy.core.authc.AbstractAuthenticator;
...
import top.ilovemyhome.security.soy.core.exception.authc.UnknownAccountException;
import top.ilovemyhome.security.soy.core.exception.authc.UnsupportedTokenException;
...
public class ModularRealmAuthenticator extends AbstractAuthenticator {
    ...
    protected void assertRealmsConfigured() throws IllegalStateException {
        ...
        if (CollectionUtil.isEmpty(realms)) {
