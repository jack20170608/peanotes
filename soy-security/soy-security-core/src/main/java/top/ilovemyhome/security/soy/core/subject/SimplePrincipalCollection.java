...
import top.ilovemyhome.commons.common.lang.StringConvertUtils;
...
public class SimplePrincipalCollection implements MutablePrincipalCollection {
    ...
    public String toString() {
        if (this.cachedToString == null) {
            ...
            if (!CollectionUtil.isEmpty(principals)) {
                this.cachedToString = StringConvertUtils.toStr(principals.toArray());
            } else {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        boolean principalsExist = !MapUtil.isEmpty(realmPrincipals);
