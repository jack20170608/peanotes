...
import top.ilovemyhome.commons.common.lang.CodecException;
import top.ilovemyhome.commons.common.lang.CodecSupport;
import top.ilovemyhome.commons.common.lang.SimpleByteSource;
import top.ilovemyhome.commons.common.text.StrUtils;
import top.ilovemyhome.security.soy.core.cipher.core.UnknownAlgorithmException;
...
public class SimpleHash extends CodecSupport implements Hash, Serializable {
    ...
    public SimpleHash(String algorithmName, Object source, Object salt, int hashIterations)
        ...
        if (!StrUtils.hasText(algorithmName)) {
