...
import top.ilovemyhome.commons.common.util.UnknownClassException;
...
public class DefaultHashFormatFactory implements HashFormatFactory {
    ...
    protected Class<?> getHashFormatClass(String packageName, String token) {
        ...
        final Iterator<String> iterator = Stream.of(
                pkg + "." + token,
                pkg + "." + StrUtils.uppercaseFirstChar(token) + "Format",
                pkg + "." + token + "Format",
                pkg + "." + StrUtils.uppercaseFirstChar(token) + "HashFormat",
                pkg + "." + token + "HashFormat",
                pkg + "." + StrUtils.uppercaseFirstChar(token) + "CryptFormat",
