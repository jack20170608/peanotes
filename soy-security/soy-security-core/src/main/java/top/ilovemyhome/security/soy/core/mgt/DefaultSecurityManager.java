...
import top.ilovemyhome.security.soy.core.authc.LogoutAware;
...
import top.ilovemyhome.security.soy.core.mgt.session.DefaultSessionKey;
import top.ilovemyhome.security.soy.core.mgt.session.SessionContext;
import top.ilovemyhome.security.soy.core.mgt.session.SessionKey;
...
import top.ilovemyhome.security.soy.core.subject.support.DefaultSubjectContext;

import java.io.Serializable;
import java.util.Collection;

/**
 * The Shiro framework's default concrete implementation of the {@link java.lang.SecurityManager} interface,
...
public class DefaultSecurityManager extends SessionsSecurityManager {
    ...
    protected SessionContext createSessionContext(SubjectContext subjectContext) {
        ...
        if (!MapUtil.isEmpty(subjectContext)) {
