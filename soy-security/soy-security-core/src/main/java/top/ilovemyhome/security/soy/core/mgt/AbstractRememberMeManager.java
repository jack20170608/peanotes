...
import top.ilovemyhome.commons.common.serialize.JdkSerializeTool;
...
import top.ilovemyhome.security.soy.core.authc.RememberMeAuthenticationToken;
import top.ilovemyhome.security.soy.core.cipher.AesCipherService;
import top.ilovemyhome.security.soy.core.cipher.ByteSourceBroker;
import top.ilovemyhome.security.soy.core.cipher.CipherService;
...
public abstract class AbstractRememberMeManager implements RememberMeManager {
    ...
    protected byte[] serialize(PrincipalCollection principals) {
        return JdkSerializeTool.serialize(principals);
    }

    protected PrincipalCollection deserialize(byte[] serializedIdentity) {
        return JdkSerializeTool.deserialize(serializedIdentity, PrincipalCollection.class);
    }
