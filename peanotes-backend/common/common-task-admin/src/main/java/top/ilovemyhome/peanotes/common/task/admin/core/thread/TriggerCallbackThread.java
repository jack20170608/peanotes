...
import top.ilovemyhome.peanotes.common.task.admin.core.common.FileUtil;
import top.ilovemyhome.peanotes.common.task.admin.core.common.JdkSerializeTool;
...
public class TriggerCallbackThread {
    ...
    private void callbackLog(List<HandleCallbackParam> callbackParamList, String logContent){
        for (HandleCallbackParam callbackParam: callbackParamList) {
            String logFileName = JobFileAppender.makeLogFileName(callbackParam.getLogDateTim(), callbackParam.getLogId());
