...
package top.ilovemyhome.peanotes.common.task.admin.core.cron;
...
public final class CronExpression implements Serializable, Cloneable {
     ...
     * expression
     */
    public boolean isSatisfiedBy(LocalDateTime date) {
        LocalDateTime originalDate = date.truncatedTo(ChronoUnit.SECONDS);
        LocalDateTime timeAfter = getTimeAfter(originalDate.minusSeconds(1));
     ...
     */
    public LocalDateTime getNextValidTimeAfter(LocalDateTime date) {
     ...
     * @return the next valid date/time
     */
    public LocalDateTime getNextInvalidTimeAfter(LocalDateTime date) {
        long difference = 1000;
        LocalDateTime lastDate = date.truncatedTo(ChronoUnit.SECONDS);
        ...
        while (difference == 1000) {
            ...
            difference = LocalDateUtils.getChronoUnitBetween(lastDate, newDate, ChronoUnit.MILLIS);
            if (difference == 1000) {
                lastDate = newDate;
            }
        }
...
//        cl.set(Calendar.MILLISECOND, 0);
        ...
        cl.set(afterTime.getYear(), afterTime.getMonthValue(), afterTime.getDayOfMonth()
            , afterTime.getHour(), afterTime.getMinute(), afterTime.getSecond() + 1);
            ...
            if (dayOfMSpec && !dayOfWSpec) { // get day by day of month rule
                ...
                if (lastdayOfMonth) {
                    if (!nearestWeekday) {
                        ...
                        tcal.set(Calendar.DAY_OF_MONTH, day);
                        tcal.set(Calendar.MONTH, mon - 1);
                        LocalDateTime nTime = LocalDateTime.ofInstant(tcal.toInstant(), ZoneId.systemDefault());
        ...
        return LocalDateTime.ofInstant(cl.toInstant(), ZoneId.systemDefault());
    }
