...
public class TaskOrder {
    ...
    public static final Map<String, String> FIELD_COLUMN_MAP
        = Collections.unmodifiableMap(Stream.of(TaskOrder.Field.values())
        .collect(Collectors.toMap(TaskOrder.Field::name, TaskOrder.Field::getDbColumn)));

    public static final String ID_FIELD = TaskOrder.Field.id.name();
