package top.ilovemyhome.peanotes.backend.common.db.dao.sample;
...
import top.ilovemyhome.peanotes.backend.common.db.dao.sample.impl.BarDaoImpl;
import top.ilovemyhome.peanotes.backend.common.db.dao.sample.impl.FooDaoImpl;
...
public class FooDaoImplTest {
    ...
    public void testCreateAutoCommit() {
        ...
        Page<Foo> firstPage = fooDao.find(
            fooSearchCriteria
            , new PageRequest(0, 2, Direction.DESC, "FIRST_NAME"));
