...
//this is copy from org.springframework.util.AntPathMatcher
/**
...
public class AntPathMatcher implements PathMatcher {
    ...
    protected String[] tokenizePath(String path) {
        return StrUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    }
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = StrUtils.tokenizeToStringArray(pattern, this.pathSeparator, this.trimTokens, true);
        String[] pathParts = StrUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    ...
    public String combine(String pattern1, String pattern2) {
        if (!StrUtils.hasText(pattern1) && !StrUtils.hasText(pattern2)) {
            return "";
        }
        if (!StrUtils.hasText(pattern1)) {
            return pattern2;
        }
        if (!StrUtils.hasText(pattern2)) {
            return pattern1;
        }
