...
import top.ilovemyhome.peanotes.commons.jdbi.page.Order;
import top.ilovemyhome.peanotes.commons.jdbi.page.Pageable;
import top.ilovemyhome.peanotes.commons.jdbi.page.Sort;
...
public class SqlGeneratorTest {
    ...
    public void testSearchCriteria() {
        ...
        pageable = new PageRequest(2, 100, Direction.DESC, "ID");
        sql = sqlGenerator.select(orderTable, criteria1, pageable);
        assertThat(sql).isEqualTo("SELECT * FROM t_order\n" +
        ...
        pageable = new PageRequest(3, 100, sort);
        sql = sqlGenerator.select(orderTable, criteria1, pageable);
        assertThat(sql).isEqualTo("SELECT * FROM t_order\n" +
