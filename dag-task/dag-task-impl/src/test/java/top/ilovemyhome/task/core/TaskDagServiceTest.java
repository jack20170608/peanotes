...
import top.ilovemyhome.task.si.TaskDagService;
...
public class TaskDagServiceTest {
    ...
    public void testTaskOrderAndRunForAsync() {
        ...
        assertThat(t1.getExecutionKey()).isEqualTo("top.ilovemyhome.task.core.execution.PrintInputTaskExecution");
        ...
        assertThat(t2.getExecutionKey()).isEqualTo("top.ilovemyhome.task.core.execution.PrintInputTaskExecution");
        ...
        assertThat(t3.getExecutionKey()).isEqualTo("top.ilovemyhome.task.core.execution.ConditionExceptionalExecution");
        ...
        assertThat(t4.getExecutionKey()).isEqualTo("top.ilovemyhome.task.core.execution.LongRunningExecution");
        ...
        assertThat(t5.getExecutionKey()).isEqualTo("top.ilovemyhome.task.core.execution.PrintInputTaskExecution");
    ...
    private TaskRecord createT1(Long id, TaskOrder taskOrder, boolean async, String input, Set<Long> successorIds) {
        return TaskRecord.builder()
            ...
            .withExecutionKey("top.ilovemyhome.task.core.execution.PrintInputTaskExecution")
    ...
    private TaskRecord createT3(Long id, TaskOrder taskOrder, boolean async, String input, Set<Long> successorIds) {
        return TaskRecord.builder()
            ...
            .withTimeout(10L)
            .withSuccessorIds(successorIds)
            .withExecutionKey("top.ilovemyhome.task.core.execution.ConditionExceptionalExecution")
            .build();
    }
    ...
    private TaskRecord createT4(Long id, TaskOrder taskOrder, boolean async, String input, Set<Long> successorIds, Long timeout) {
        return TaskRecord.builder()
            ...
            .withTimeoutUnit(TimeUnit.SECONDS)
            .withSuccessorIds(successorIds)
            .withExecutionKey("top.ilovemyhome.task.core.execution.LongRunningExecution")
            .build();
    }
